...
// --- Partners (12) ---
// Team 1 (HQ): 1, 3, 6, 10
// Team 2 (Accra Central): 2, 4, 5, 8, 12
// Team 3 (Kumasi): 7, 9, 11
export const demoPartners: Partner[] = [
  { id: 1, name: "Kwame Asante Chiller Hub", phone: "+233241000001", type: "CHILLER", location: "Osu, Accra", status: "active", last_activity: fmtTime(subHours(now, 2)), latitude: 5.5560, longitude: -0.1820, geolocation_captured_at: fmt(subDays(now, 30)), team_id: 1, team_name: TEAM_HQ, created_at: fmt(subDays(now, 120)), updated_at: fmt(subDays(now, 2)) },
  { id: 2, name: "Amina Ice Water Express", phone: "+233241000002", type: "ICE_WATER_SELLER", location: "Madina, Accra", status: "active", last_activity: fmtTime(subHours(now, 5)), latitude: 5.6700, longitude: -0.1674, geolocation_captured_at: fmt(subDays(now, 25)), team_id: 2, team_name: TEAM_ACCRA, created_at: fmt(subDays(now, 100)), updated_at: fmt(subDays(now, 1)) },
  { id: 3, name: "Akosua Cold Drinks", phone: "+233241000003", type: "CHILLER", location: "Cantonments, Accra", status: "active", last_activity: fmtTime(subHours(now, 8)), latitude: 5.5620, longitude: -0.1730, geolocation_captured_at: fmt(subDays(now, 15)), team_id: 1, team_name: TEAM_HQ, created_at: fmt(subDays(now, 90)), updated_at: fmt(subDays(now, 3)) },
  { id: 4, name: "Efua Pure Water", phone: "+233241000004", type: "ICE_WATER_SELLER", location: "East Legon, Accra", status: "active", last_activity: fmtTime(subDays(now, 1)), latitude: 5.6380, longitude: -0.1580, geolocation_captured_at: fmt(subDays(now, 10)), team_id: 2, team_name: TEAM_ACCRA, created_at: fmt(subDays(now, 80)), updated_at: fmt(subDays(now, 1)) },
  { id: 5, name: "Kofi Chill Zone", phone: "+233241000005", type: "CHILLER", location: "Tema, Accra", status: "suspended", last_activity: fmtTime(subDays(now, 14)), latitude: 5.6698, longitude: -0.0166, geolocation_captured_at: fmt(subDays(now, 60)), team_id: 2, team_name: TEAM_ACCRA, created_at: fmt(subDays(now, 150)), updated_at: fmt(subDays(now, 14)) },
  { id: 6, name: "Abena Ice Point", phone: "+233241000006", type: "ICE_WATER_SELLER", location: "Dansoman, Accra", status: "active", last_activity: fmtTime(subHours(now, 3)), latitude: 5.5480, longitude: -0.2610, geolocation_captured_at: fmt(subDays(now, 20)), team_id: 1, team_name: TEAM_HQ, created_at: fmt(subDays(now, 70)), updated_at: fmt(subDays(now, 2)) },
  { id: 7, name: "Yaw Fresh Beverages", phone: "+233241000007", type: "CHILLER", location: "Kumasi", status: "active", last_activity: fmtTime(subHours(now, 12)), latitude: null, longitude: null, geolocation_captured_at: null, team_id: 3, team_name: TEAM_KUMASI, created_at: fmt(subDays(now, 60)), updated_at: fmt(subDays(now, 5)) },
  { id: 8, name: "Nana Cooler Station", phone: "+233241000008", type: "CHILLER", location: "Airport Residential, Accra", status: "active", last_activity: fmtTime(subHours(now, 1)), latitude: 5.6050, longitude: -0.1810, geolocation_captured_at: fmt(subDays(now, 5)), team_id: 2, team_name: TEAM_ACCRA, created_at: fmt(subDays(now, 45)), updated_at: fmt(subHours(now, 1)) },
  { id: 9, name: "Ama Sachet Water", phone: "+233241000009", type: "ICE_WATER_SELLER", location: "Takoradi", status: "active", last_activity: fmtTime(subDays(now, 2)), latitude: null, longitude: null, geolocation_captured_at: null, team_id: 3, team_name: TEAM_KUMASI, created_at: fmt(subDays(now, 40)), updated_at: fmt(subDays(now, 2)) },
  { id: 10, name: "Kojo Refresh Corner", phone: "+233241000010", type: "CHILLER", location: "Achimota, Accra", status: "active", last_activity: fmtTime(subHours(now, 6)), latitude: 5.6310, longitude: -0.2280, geolocation_captured_at: fmt(subDays(now, 8)), team_id: 1, team_name: TEAM_HQ, created_at: fmt(subDays(now, 35)), updated_at: fmt(subDays(now, 1)) },
  { id: 11, name: "Adjoa Cool Spot", phone: "+233241000011", type: "ICE_WATER_SELLER", location: "Kasoa", status: "suspended", last_activity: fmtTime(subDays(now, 21)), latitude: null, longitude: null, geolocation_captured_at: null, team_id: 3, team_name: TEAM_KUMASI, created_at: fmt(subDays(now, 90)), updated_at: fmt(subDays(now, 21)) },
  { id: 12, name: "Kwesi Drinks Depot", phone: "+233241000012", type: "CHILLER", location: "Spintex, Accra", status: "active", last_activity: fmtTime(subHours(now, 4)), latitude: 5.6340, longitude: -0.1020, geolocation_captured_at: fmt(subDays(now, 3)), team_id: 2, team_name: TEAM_ACCRA, created_at: fmt(subDays(now, 20)), updated_at: fmt(subHours(now, 4)) },
];

// --- Campaigns (6) ---
// Team 1 (HQ): 1, 3, 6
// Team 2 (Accra Central): 2, 5
// Team 3 (Kumasi): 4
export const demoCampaigns: Campaign[] = [
  { id: 1, name: "Q1 Volume Push", type: "VOLUME_REBATE", status: "active", start_date: fmt(subDays(now, 45)), end_date: fmt(addDays(now, 45)), tiers: [{ threshold: 50, reward_amount: 500 }, { threshold: 100, reward_amount: 1200 }, { threshold: 200, reward_amount: 3000 }], total_redemptions: 234, total_spend: 156000, team_id: 1, team_name: TEAM_HQ, created_at: fmt(subDays(now, 50)) },
  { id: 2, name: "Mystery Shopper Feb", type: "MYSTERY_SHOPPER", status: "active", start_date: fmt(subDays(now, 20)), end_date: fmt(addDays(now, 10)), reward_amount: 2000, total_redemptions: 18, total_spend: 36000, team_id: 2, team_name: TEAM_ACCRA, created_at: fmt(subDays(now, 25)) },
  { id: 3, name: "Ramadan Special Rebate", type: "VOLUME_REBATE", status: "ended", start_date: fmt(subDays(now, 90)), end_date: fmt(subDays(now, 30)), tiers: [{ threshold: 30, reward_amount: 300 }, { threshold: 80, reward_amount: 900 }], total_redemptions: 412, total_spend: 287000, team_id: 1, team_name: TEAM_HQ, created_at: fmt(subDays(now, 95)) },
  { id: 4, name: "Easter Cool Down", type: "VOLUME_REBATE", status: "paused", start_date: fmt(subDays(now, 10)), end_date: fmt(addDays(now, 30)), tiers: [{ threshold: 40, reward_amount: 400 }], total_redemptions: 45, total_spend: 18000, team_id: 3, team_name: TEAM_KUMASI, created_at: fmt(subDays(now, 15)) },
  { id: 5, name: "New Partner Welcome", type: "MYSTERY_SHOPPER", status: "draft", start_date: fmt(addDays(now, 5)), end_date: fmt(addDays(now, 35)), reward_amount: 1500, total_redemptions: 0, total_spend: 0, team_id: 2, team_name: TEAM_ACCRA, created_at: fmt(subDays(now, 3)) },
  { id: 6, name: "Summer Blitz 2025", type: "VOLUME_REBATE", status: "draft", start_date: fmt(addDays(now, 15)), end_date: fmt(addDays(now, 75)), tiers: [{ threshold: 60, reward_amount: 600 }, { threshold: 150, reward_amount: 2000 }], total_redemptions: 0, total_spend: 0, team_id: 1, team_name: TEAM_HQ, created_at: fmt(subDays(now, 1)) },
];
...
// --- Orders (10) ---
// Align team_id with partner's team
...
// --- Map Partners (8) ---
// Same team assignments as demoPartners
export const demoMapPartners: MapPartner[] = [
  { id: 1, name: "Kwame Asante Chiller Hub", type: "CHILLER", status: "active", phone: "+233241000001", location: "Osu, Accra", latitude: 5.5560, longitude: -0.1820, last_activity: fmtTime(subHours(now, 2)), redemptions_count: 12, redemptions_amount: 8400, orders_count: 5, orders_amount: 78000, pending_payouts_count: 0, pending_payouts_amount: 0, team_id: 1, team_name: TEAM_HQ },
  { id: 2, name: "Amina Ice Water Express", type: "ICE_WATER_SELLER", status: "active", phone: "+233241000002", location: "Madina, Accra", latitude: 5.6700, longitude: -0.1674, last_activity: fmtTime(subHours(now, 5)), redemptions_count: 6, redemptions_amount: 4200, orders_count: 3, orders_amount: 18500, pending_payouts_count: 1, pending_payouts_amount: 2000, team_id: 2, team_name: TEAM_ACCRA },
  { id: 3, name: "Akosua Cold Drinks", type: "CHILLER", status: "active", phone: "+233241000003", location: "Cantonments, Accra", latitude: 5.5620, longitude: -0.1730, last_activity: fmtTime(subHours(now, 8)), redemptions_count: 8, redemptions_amount: 5600, orders_count: 4, orders_amount: 32000, pending_payouts_count: 0, pending_payouts_amount: 0, team_id: 1, team_name: TEAM_HQ },
  { id: 4, name: "Efua Pure Water", type: "ICE_WATER_SELLER", status: "active", phone: "+233241000004", location: "East Legon, Accra", latitude: 5.6380, longitude: -0.1580, last_activity: fmtTime(subDays(now, 1)), redemptions_count: 4, redemptions_amount: 3600, orders_count: 2, orders_amount: 25000, pending_payouts_count: 0, pending_payouts_amount: 0, team_id: 2, team_name: TEAM_ACCRA },
  { id: 6, name: "Abena Ice Point", type: "ICE_WATER_SELLER", status: "active", phone: "+233241000006", location: "Dansoman, Accra", latitude: 5.5480, longitude: -0.2610, last_activity: fmtTime(subHours(now, 3)), redemptions_count: 3, redemptions_amount: 6000, orders_count: 2, orders_amount: 12000, pending_payouts_count: 0, pending_payouts_amount: 0, team_id: 1, team_name: TEAM_HQ },
  { id: 8, name: "Nana Cooler Station", type: "CHILLER", status: "active", phone: "+233241000008", location: "Airport Residential, Accra", latitude: 5.6050, longitude: -0.1810, last_activity: fmtTime(subHours(now, 1)), redemptions_count: 15, redemptions_amount: 18000, orders_count: 7, orders_amount: 67000, pending_payouts_count: 1, pending_payouts_amount: 3000, team_id: 2, team_name: TEAM_ACCRA },
  { id: 10, name: "Kojo Refresh Corner", type: "CHILLER", status: "active", phone: "+233241000010", location: "Achimota, Accra", latitude: 5.6310, longitude: -0.2280, last_activity: fmtTime(subHours(now, 6)), redemptions_count: 5, redemptions_amount: 3500, orders_count: 3, orders_amount: 38000, pending_payouts_count: 0, pending_payouts_amount: 0, team_id: 1, team_name: TEAM_HQ },
  { id: 12, name: "Kwesi Drinks Depot", type: "CHILLER", status: "active", phone: "+233241000012", location: "Spintex, Accra", latitude: 5.6340, longitude: -0.1020, last_activity: fmtTime(subHours(now, 4)), redemptions_count: 2, redemptions_amount: 800, orders_count: 1, orders_amount: 54000, pending_payouts_count: 1, pending_payouts_amount: 400, team_id: 2, team_name: TEAM_ACCRA },
];
