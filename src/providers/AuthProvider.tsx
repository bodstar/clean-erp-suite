  ...
  teams: [
    {
      ...
      permissions: [
        ...
        "mpromo.campaigns.view", "mpromo.campaigns.manage", "mpromo.campaigns.activate",
        "mpromo.codes.view", "mpromo.codes.generate", "mpromo.codes.cancel",
        "mpromo.redemptions.view", "mpromo.redemptions.redeem",
        "mpromo.payouts.view", "mpromo.payouts.trigger",
        "mpromo.orders.view", "mpromo.orders.create",
        "mpromo.zones.view", "mpromo.zones.manage",
        "mpromo.market_data.view", "mpromo.market_data.forms.manage", "mpromo.market_data.submit",
        "mpromo.hq.global_view", "mpromo.hq.run_campaigns_any_team",
        "sd.view", "sd.orders.view", "sd.orders.create", "sd.orders.manage",
        "sd.products.view", "sd.products.manage",
    ...
    },
    {
      ...
      permissions: [
        ...
        "mpromo.partners.view", "mpromo.partners.create", "mpromo.partners.update",
        "mpromo.partners.suspend", "mpromo.partners.points",
        "mpromo.campaigns.view", "mpromo.campaigns.manage",
        "mpromo.codes.view", "mpromo.codes.generate", "mpromo.codes.cancel",
        "mpromo.redemptions.view", "mpromo.redemptions.redeem",
        "mpromo.orders.view", "mpromo.orders.create",
        "mpromo.zones.view",
        "mpromo.market_data.view", "mpromo.market_data.forms.manage", "mpromo.market_data.submit",
        "sd.view", "sd.orders.view", "sd.orders.create",
        "sd.products.view", "sd.customers.view", "sd.customers.manage",
      ],
    },
    {
      id: 3,
